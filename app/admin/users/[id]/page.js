      ...
      <section className="admin-container">
        ...
        <div className="admin-user-profile-card">
          ...
          <div>
            ...
            <h1 className="admin-title">{user.name || "Unnamed User"}</h1>
        ...
        <div className="admin-user-detail-grid">
          ...
          <article className="admin-user-detail-card">
            ...
            {currentMembership ? (
              ...
              <p className="admin-text">No membership found.</p>
            )}
          </article>

          <article className="admin-user-detail-card admin-user-bio-card">
            <h2>Biography</h2>
          ...
          {user.memberships.length > 0 ? (
            <div className="admin-user-events-list">
              {user.memberships.map((membership) => (
                <div key={membership.id} className="admin-user-event-item">
                  <div>
            ...
            <p className="admin-text">No memberships assigned yet.</p>
          )}
        </div>
          ...
          {user.eventBookings.length > 0 ? (
            <div className="admin-user-events-list">
              {user.eventBookings.map((booking) => (
                <div key={booking.id} className="admin-user-event-item">
                  <div>
                  ...
                  <span
                    className={`admin-status ${
                      booking.attended ? "active" : "inactive"
                    }`}
                  >
            ...
            <p className="admin-text">No event registrations yet.</p>
          )}
        </div>
      </section>
    </main>
