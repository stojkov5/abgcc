  ...
  return baseTemplate({
    ...
    content: `
      ...
      <div style="background:#f8fafc;border:1px solid #e5eaf2;border-radius:14px;padding:20px 24px;margin-bottom:24px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr><td style="padding:6px 0;font-size:14px;color:#64748b;width:140px;">Bank</td><td style="padding:6px 0;font-size:15px;color:#10243f;font-weight:600;">${bank.bankName}</td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#64748b;">Account Name</td><td style="padding:6px 0;font-size:15px;color:#10243f;font-weight:600;">${bank.accountName}</td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#64748b;">IBAN</td><td style="padding:6px 0;font-size:15px;color:#10243f;font-weight:600;">${bank.iban}</td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#64748b;">SWIFT / BIC</td><td style="padding:6px 0;font-size:15px;color:#10243f;font-weight:600;">${bank.swift}</td></tr>
          <tr><td style="padding:6px 0;font-size:14px;color:#64748b;">Bank Address</td><td style="padding:6px 0;font-size:15px;color:#10243f;font-weight:600;">${bank.address}</td></tr>
        </table>
      </div>
